    ...
    public class EditorModel
    {
        ...
        public void InitColleges(MGMT man)
        {
            ...
            if (man.stream_model == null)
            {
                ...
                {
                    Colleges.Add(0, new college_entry(CurrentYearIndex, 0, "N/A", -1));
                    Colleges.Add(1, new college_entry(CurrentYearIndex, 1, "Abilene Christian", -1));
                    ...
                    Colleges.Add(6, new college_entry(CurrentYearIndex, 6, "Alabama State", -1));
                    Colleges.Add(7, new college_entry(CurrentYearIndex, 7, "Alcorn State", -1));
                    Colleges.Add(8, new college_entry(CurrentYearIndex, 8, "Appalachian State", -1));
                    Colleges.Add(9, new college_entry(CurrentYearIndex, 9, "Arizona", -1));

                    Colleges.Add(10, new college_entry(CurrentYearIndex, 10, "Arizona State", -1));
                    Colleges.Add(11, new college_entry(CurrentYearIndex, 11, "Arkansas", -1));
                    Colleges.Add(12, new college_entry(CurrentYearIndex, 12, "Arkansas-Pine Bluff", -1));
                    Colleges.Add(13, new college_entry(CurrentYearIndex, 13, "Arkansas State", -1));
                    ...
                    Colleges.Add(22, new college_entry(CurrentYearIndex, 22, "Bowling Green State", -1));
                    ...
                    Colleges.Add(30, new college_entry(CurrentYearIndex, 30, "California-Northridge", -1));
                    Colleges.Add(31, new college_entry(CurrentYearIndex, 31, "California-Sacramento", -1));
                    Colleges.Add(32, new college_entry(CurrentYearIndex, 32, "Canisius", -1));
                    Colleges.Add(33, new college_entry(CurrentYearIndex, 33, "Central Connecticut State", -1));
                    Colleges.Add(34, new college_entry(CurrentYearIndex, 34, "Eastern Michigan", -1));
                    Colleges.Add(35, new college_entry(CurrentYearIndex, 35, "Central State Ohio", -1));
                    Colleges.Add(36, new college_entry(CurrentYearIndex, 36, "Charleston Southern", -1));
                    ...
                    Colleges.Add(43, new college_entry(CurrentYearIndex, 43, "Colorado State", -1));
                    ...
                    Colleges.Add(51, new college_entry(CurrentYearIndex, 51, "Delaware State", -1));
                    ...
                    Colleges.Add(56, new college_entry(CurrentYearIndex, 56, "Eastern Illinois", -1));
                    Colleges.Add(57, new college_entry(CurrentYearIndex, 57, "Eastern Kentucky", -1));
                    Colleges.Add(58, new college_entry(CurrentYearIndex, 58, "East Tennessee State", -1));
                    Colleges.Add(59, new college_entry(CurrentYearIndex, 59, "East Carolina", -1));

                    Colleges.Add(60, new college_entry(CurrentYearIndex, 60, "Eastern Washington", -1));
                    ...
                    Colleges.Add(69, new college_entry(CurrentYearIndex, 69, "Georgia Southern", -1));
                    ...
                    Colleges.Add(73, new college_entry(CurrentYearIndex, 73, "Grambling State", -1));
                    Colleges.Add(74, new college_entry(CurrentYearIndex, 74, "Grand Valley State", -1));
                    ...
                    Colleges.Add(78, new college_entry(CurrentYearIndex, 78, "Henderson State", -1));
                    ...
                    Colleges.Add(86, new college_entry(CurrentYearIndex, 86, "Illinois State", -1));
                    Colleges.Add(87, new college_entry(CurrentYearIndex, 87, "Indiana", -1));
                    Colleges.Add(88, new college_entry(CurrentYearIndex, 88, "Indiana State", -1));
                    ...
                    Colleges.Add(92, new college_entry(CurrentYearIndex, 92, "James Madison", -1));
                    Colleges.Add(93, new college_entry(CurrentYearIndex, 93, "Jackson State", -1));
                    Colleges.Add(94, new college_entry(CurrentYearIndex, 94, "Jacksonville State", -1));
                    ...
                    Colleges.Add(102, new college_entry(CurrentYearIndex, 102, "Louisiana Tech", 1));
                    ...
                    Colleges.Add(108, new college_entry(CurrentYearIndex, 108, "Mississippi Valley St.", -1));
                    ...
                    Colleges.Add(114, new college_entry(CurrentYearIndex, 114, "McNeese State", -1));
                    Colleges.Add(115, new college_entry(CurrentYearIndex, 115, "Memphis", 1));
                    Colleges.Add(116, new college_entry(CurrentYearIndex, 116, "Miami (FL)", -1));
                    Colleges.Add(117, new college_entry(CurrentYearIndex, 117, "Miami (OH)", -1));
                    Colleges.Add(118, new college_entry(CurrentYearIndex, 118, "Michigan", 1));
                    Colleges.Add(119, new college_entry(CurrentYearIndex, 119, "Michigan State", 1));

                    Colleges.Add(120, new college_entry(CurrentYearIndex, 120, "Middle Tennesse St.", -1));
                    ...
                    Colleges.Add(127, new college_entry(CurrentYearIndex, 127, "Morehead State", -1));
                    Colleges.Add(128, new college_entry(CurrentYearIndex, 128, "Morehouse", -1));
                    Colleges.Add(129, new college_entry(CurrentYearIndex, 129, "Morgan State", -1));

                    Colleges.Add(130, new college_entry(CurrentYearIndex, 130, "Morris Brown", -1));
                    Colleges.Add(131, new college_entry(CurrentYearIndex, 131, "Mt. San Antonio", -1));
                    Colleges.Add(132, new college_entry(CurrentYearIndex, 132, "Murray State", -1));
                    Colleges.Add(133, new college_entry(CurrentYearIndex, 133, "North Alabama", -1));
                    Colleges.Add(134, new college_entry(CurrentYearIndex, 134, "North Arizona", -1));
                    ...
                    Colleges.Add(137, new college_entry(CurrentYearIndex, 137, "Northern Colorado", -1));
                    Colleges.Add(138, new college_entry(CurrentYearIndex, 138, "Northern Illinois", -1));
                    ...
                    Colleges.Add(142, new college_entry(CurrentYearIndex, 142, "Nebraska-Omaha", -1));
                    ...
                    Colleges.Add(145, new college_entry(CurrentYearIndex, 145, "New Mexico State", -1));
                    Colleges.Add(146, new college_entry(CurrentYearIndex, 146, "New Mexico", -1));
                    Colleges.Add(147, new college_entry(CurrentYearIndex, 147, "Nicholls State", -1));
                    ...
                    Colleges.Add(154, new college_entry(CurrentYearIndex, 154, "NW Oklahoma State", -1));
                    Colleges.Add(155, new college_entry(CurrentYearIndex, 155, "Northwestern State", -1));
                    ...
                    Colleges.Add(159, new college_entry(CurrentYearIndex, 159, "Oklahoma State", -1));
                    ...
                    Colleges.Add(163, new college_entry(CurrentYearIndex, 163, "Prairie View A&M", -1));
                    ...
                    Colleges.Add(166, new college_entry(CurrentYearIndex, 166, "Pittsburg State", -1));
                    Colleges.Add(167, new college_entry(CurrentYearIndex, 167, "Pittsburgh", -1));
                    Colleges.Add(168, new college_entry(CurrentYearIndex, 168, "Portland State", -1));
                    ...
                    Colleges.Add(178, new college_entry(CurrentYearIndex, 178, "South Dakota State", -1));
                    Colleges.Add(179, new college_entry(CurrentYearIndex, 179, "Southern Illinois", -1));

                    Colleges.Add(180, new college_entry(CurrentYearIndex, 180, "South Carolina State", -1));
                    ...
                    Colleges.Add(186, new college_entry(CurrentYearIndex, 186, "San Jose State", -1));
                    Colleges.Add(187, new college_entry(CurrentYearIndex, 187, "Savannah State", -1));
                    Colleges.Add(188, new college_entry(CurrentYearIndex, 188, "SE Missouri", -1));
                    Colleges.Add(189, new college_entry(CurrentYearIndex, 189, "SE Missouri State", -1));
                    ...
                    Colleges.Add(207, new college_entry(CurrentYearIndex, 207, "Texas A&M Kingsville", -1));
                    ...
                    Colleges.Add(210, new college_entry(CurrentYearIndex, 210, "Tennesse Tech", -1));
                    Colleges.Add(211, new college_entry(CurrentYearIndex, 211, "Tennesse-Chat", -1));
                    Colleges.Add(212, new college_entry(CurrentYearIndex, 212, "Tennessee", -1));
                    Colleges.Add(213, new college_entry(CurrentYearIndex, 213, "Tennessee State", -1));
                    ...
                    Colleges.Add(217, new college_entry(CurrentYearIndex, 217, "Texas Southern", -1));
                    ...
                    Colleges.Add(229, new college_entry(CurrentYearIndex, 229, "Louisiana-Lafayette", -1));

                    Colleges.Add(230, new college_entry(CurrentYearIndex, 230, "Louisiana-Monroe", -1));
                    ...
                    Colleges.Add(237, new college_entry(CurrentYearIndex, 237, "Valdosta State", -1));
                    ...
                    Colleges.Add(244, new college_entry(CurrentYearIndex, 244, "Western Carolina", -1));
                    Colleges.Add(245, new college_entry(CurrentYearIndex, 245, "Western Illinois", -1));
                    Colleges.Add(246, new college_entry(CurrentYearIndex, 246, "Western Kentucky", -1));
                    Colleges.Add(247, new college_entry(CurrentYearIndex, 247, "Western Michigan", -1));
                    Colleges.Add(248, new college_entry(CurrentYearIndex, 248, "Western Texas A&M", -1));
                    ...
                    Colleges.Add(252, new college_entry(CurrentYearIndex, 252, "Washington State", -1));
                    ...
                    Colleges.Add(263, new college_entry(CurrentYearIndex, 263, "Youngstown State", -1));
                    Colleges.Add(264, new college_entry(CurrentYearIndex, 264, "Sonoma State", -1));
                    Colleges.Add(265, new college_entry(CurrentYearIndex, 265, "No College", -1));
                    Colleges.Add(266, new college_entry(CurrentYearIndex, 266, "New Hampshire", -1));
                    Colleges.Add(267, new college_entry(CurrentYearIndex, 267, "UW Lacrosse", -1));
                    Colleges.Add(268, new college_entry(CurrentYearIndex, 268, "Hastings College", -1));
                    Colleges.Add(269, new college_entry(CurrentYearIndex, 269, "Midwestern State", -1));

                    Colleges.Add(270, new college_entry(CurrentYearIndex, 270, "North Dakota", -1));
                    Colleges.Add(271, new college_entry(CurrentYearIndex, 271, "Wayne State", -1));
                    Colleges.Add(272, new college_entry(CurrentYearIndex, 272, "UW Stevens Point", -1));
                    ...
                    Colleges.Add(279, new college_entry(CurrentYearIndex, 279, "Western New Mexico", -1));
                    ...
                    Colleges.Add(296, new college_entry(CurrentYearIndex, 296, "Ferris State", -1));
                    ...
                    Colleges.Add(299, new college_entry(CurrentYearIndex, 299, "Fort Valley State", -1));
                    ...
                    Colleges.Add(304, new college_entry(CurrentYearIndex, 304, "Carroll College (WI)", -1));
                    Colleges.Add(305, new college_entry(CurrentYearIndex, 305, "St.Cloud State", -1));
                    ...
                    Colleges.Add(311, new college_entry(CurrentYearIndex, 311, "Missouri Western State", -1));
                    ...
                    Colleges.Add(315, new college_entry(CurrentYearIndex, 315, "North Dakota State", -1));
                    ...
                    Colleges.Add(336, new college_entry(CurrentYearIndex, 336, "Bridgewater State", -1));
                    ...
                    Colleges.Add(347, new college_entry(CurrentYearIndex, 347, "Southern Connecticut St.", -1));
                    ...
                    Colleges.Add(369, new college_entry(CurrentYearIndex, 369, "Queen's University", -1));
                    ...
                    Colleges.Add(384, new college_entry(CurrentYearIndex, 384, "East Central University", -1));
                    ...
                    Colleges.Add(389, new college_entry(CurrentYearIndex, 389, "Montreal University", -1));

                    Colleges.Add(390, new college_entry(CurrentYearIndex, 390, "Minnesota State", -1));
                    ...
                    Colleges.Add(395, new college_entry(CurrentYearIndex, 395, "Shepherd University", -1));
                    Colleges.Add(396, new college_entry(CurrentYearIndex, 396, "Northeastern State", -1));
                    Colleges.Add(397, new college_entry(CurrentYearIndex, 397, "UC Irvine", -1));
                    Colleges.Add(398, new college_entry(CurrentYearIndex, 398, "McGill University", -1));
                    ...
                    Colleges.Add(403, new college_entry(CurrentYearIndex, 403, "Lamar University", -1));
                    ...
                    Colleges.Add(407, new college_entry(CurrentYearIndex, 407, "Jacksonville University", -1));
                    ...
                    Colleges.Add(410, new college_entry(CurrentYearIndex, 410, "Campbell University", -1));
                ...
                if (madversion == MaddenFileVersion.Ver2020)
                {
                    ...
                    Colleges.Add(284, new college_entry(CurrentYearIndex, 284, "Whitworth", -1));
                    Colleges.Add(285, new college_entry(CurrentYearIndex, 285, "Buffalo State", -1));
                    Colleges.Add(286, new college_entry(CurrentYearIndex, 286, "UC Davis", -1));
                    Colleges.Add(287, new college_entry(CurrentYearIndex, 287, "Carson-Newman", -1));
                    Colleges.Add(288, new college_entry(CurrentYearIndex, 288, "Central Arkansas", -1));
                    Colleges.Add(289, new college_entry(CurrentYearIndex, 289, "Berry College", -1));
                    Colleges.Add(290, new college_entry(CurrentYearIndex, 290, "Coastal Carolina", -1));
                    Colleges.Add(291, new college_entry(CurrentYearIndex, 291, "Tusculum College", -1));
                    Colleges.Add(292, new college_entry(CurrentYearIndex, 292, "East Stroudsburg", -1));
                    Colleges.Add(293, new college_entry(CurrentYearIndex, 293, "Cal State Bakersfield", -1));
                    Colleges.Add(294, new college_entry(CurrentYearIndex, 294, "Central Washington", -1));
                    Colleges.Add(295, new college_entry(CurrentYearIndex, 295, "Bentley College", -1));
                    Colleges.Add(296, new college_entry(CurrentYearIndex, 296, "Ferris State", -1));
                    Colleges.Add(297, new college_entry(CurrentYearIndex, 297, "FIU", -1));
                    Colleges.Add(298, new college_entry(CurrentYearIndex, 298, "Delta State", -1));
                    ...
                    Colleges.Add(302, new college_entry(CurrentYearIndex, 302, "Lafayette", -1));
                    Colleges.Add(303, new college_entry(CurrentYearIndex, 303, "Lane", -1));
                    Colleges.Add(304, new college_entry(CurrentYearIndex, 304, "Carroll College", -1));
                    Colleges.Add(305, new college_entry(CurrentYearIndex, 305, "St. Cloud State", -1));
                    Colleges.Add(306, new college_entry(CurrentYearIndex, 306, "Mesa State", -1));
                    Colleges.Add(307, new college_entry(CurrentYearIndex, 307, "California (PA)", -1));
                    Colleges.Add(308, new college_entry(CurrentYearIndex, 308, "FAU", -1));
                    Colleges.Add(309, new college_entry(CurrentYearIndex, 309, "Missouri Southern State", -1));
                    Colleges.Add(310, new college_entry(CurrentYearIndex, 310, "Missouri State", -1));
                    Colleges.Add(311, new college_entry(CurrentYearIndex, 311, "Missouri Western State", -1));
                    Colleges.Add(312, new college_entry(CurrentYearIndex, 312, "Mount Union", -1));
                    Colleges.Add(313, new college_entry(CurrentYearIndex, 313, "Nebraska-Kearney", -1));
                    ...
                    Colleges.Add(316, new college_entry(CurrentYearIndex, 316, "Northern State", -1));
                    Colleges.Add(317, new college_entry(CurrentYearIndex, 317, "NW Missouri State", -1));
                    Colleges.Add(318, new college_entry(CurrentYearIndex, 318, "Northwood", -1));
                    Colleges.Add(319, new college_entry(CurrentYearIndex, 319, "Ohio Northern", -1));
                    Colleges.Add(320, new college_entry(CurrentYearIndex, 320, "Ottawa", -1));
                    Colleges.Add(321, new college_entry(CurrentYearIndex, 321, "Pikeville", -1));
                    Colleges.Add(322, new college_entry(CurrentYearIndex, 322, "Ramapo", -1));
                    Colleges.Add(323, new college_entry(CurrentYearIndex, 323, "Regina", -1));
                    Colleges.Add(324, new college_entry(CurrentYearIndex, 324, "Lindenwood", -1));
                    Colleges.Add(325, new college_entry(CurrentYearIndex, 325, "Sacramento State", -1));
                    ...
                    Colleges.Add(337, new college_entry(CurrentYearIndex, 337, "Virginia Union", -1));
                    Colleges.Add(338, new college_entry(CurrentYearIndex, 338, "Washburn", -1));
                    Colleges.Add(339, new college_entry(CurrentYearIndex, 339, "Western Washington", -1));
                    Colleges.Add(340, new college_entry(CurrentYearIndex, 340, "St. Paul's", -1));
                    Colleges.Add(341, new college_entry(CurrentYearIndex, 341, "William Penn", -1));
                    Colleges.Add(342, new college_entry(CurrentYearIndex, 342, "West Georgia", -1));
                    Colleges.Add(343, new college_entry(CurrentYearIndex, 343, "Wisc-Whitewater", -1));
                    ...
                    Colleges.Add(345, new college_entry(CurrentYearIndex, 345, "Knoxville College", -1));
                    Colleges.Add(346, new college_entry(CurrentYearIndex, 346, "Western Ontario", -1));
                    Colleges.Add(347, new college_entry(CurrentYearIndex, 347, "S. Connecticut State", -1));
                    Colleges.Add(348, new college_entry(CurrentYearIndex, 348, "Manitoba", -1));
                    Colleges.Add(349, new college_entry(CurrentYearIndex, 349, "Clarion", -1));
                    Colleges.Add(350, new college_entry(CurrentYearIndex, 350, "Western Oregon", -1));
                    Colleges.Add(351, new college_entry(CurrentYearIndex, 351, "Tiffin", -1));
                    ...
                    Colleges.Add(400, new college_entry(CurrentYearIndex, 400, "Texas A&M-Commerce", -1));
                    Colleges.Add(401, new college_entry(CurrentYearIndex, 401, "Mars Hill", -1));
                    Colleges.Add(402, new college_entry(CurrentYearIndex, 402, "Louisiana Christian", -1));
                    Colleges.Add(403, new college_entry(CurrentYearIndex, 403, "Lamar University", -1));
                    Colleges.Add(404, new college_entry(CurrentYearIndex, 404, "SW Oklahoma State", -1));
                    Colleges.Add(405, new college_entry(CurrentYearIndex, 405, "Florida Tech", -1));
                    Colleges.Add(406, new college_entry(CurrentYearIndex, 406, "Fayetteville State", -1));
                    ...
                    Colleges.Add(426, new college_entry(CurrentYearIndex, 426, "Southern Oregon", -1));
                    Colleges.Add(427, new college_entry(CurrentYearIndex, 427, "Faulkner", -1));
                    Colleges.Add(428, new college_entry(CurrentYearIndex, 428, "Charleston", -1));
                    Colleges.Add(429, new college_entry(CurrentYearIndex, 429, "Greenville College", -1));
                    Colleges.Add(430, new college_entry(CurrentYearIndex, 430, "Lake Erie College", -1));
                    Colleges.Add(431, new college_entry(CurrentYearIndex, 431, "Laval", -1));
                    Colleges.Add(432, new college_entry(CurrentYearIndex, 432, "Mississippi College", -1));
                    ...
                    Colleges.Add(438, new college_entry(CurrentYearIndex, 438, "Kentucky Wesleyan", -1));
                    Colleges.Add(439, new college_entry(CurrentYearIndex, 439, "Azusa Pacific", -1));
                    Colleges.Add(440, new college_entry(CurrentYearIndex, 440, "Western Colorado ", -1));
                    Colleges.Add(441, new college_entry(CurrentYearIndex, 441, "Dubuque", -1));
                    Colleges.Add(442, new college_entry(CurrentYearIndex, 442, "Virginia State", -1));
                    Colleges.Add(443, new college_entry(CurrentYearIndex, 443, "Notre Dame College", -1));
                    Colleges.Add(444, new college_entry(CurrentYearIndex, 444, "Fairmont State", -1));
                    Colleges.Add(445, new college_entry(CurrentYearIndex, 445, "Univ. British Columbia", -1));
                    Colleges.Add(446, new college_entry(CurrentYearIndex, 446, "Frostburg State", -1));
                    Colleges.Add(447, new college_entry(CurrentYearIndex, 447, "Sioux Falls", -1));
                    Colleges.Add(448, new college_entry(CurrentYearIndex, 448, "East Texas Baptist", -1));
                    Colleges.Add(449, new college_entry(CurrentYearIndex, 449, "Southern Nazarene ", -1));
        ...
        public void InitCap()
        {
            LeagueCap.Add(2003, 120);
            LeagueCap.Add(2004, 120);
            LeagueCap.Add(2005, 120);
            LeagueCap.Add(2006, 120);
            LeagueCap.Add(2007, 120);
            LeagueCap.Add(2008, 120);
            LeagueCap.Add(2009, 123);
            LeagueCap.Add(2010, 999);       // uncapped year
            LeagueCap.Add(2011, 120.37);
            LeagueCap.Add(2012, 120.6);
            LeagueCap.Add(2013, 123.6);
            ...
            LeagueCap.Add(2020, 198.20);
            LeagueCap.Add(2021, 182.50);
            LeagueCap.Add(2022, 208.20);
            LeagueCap.Add(2023, 224.80);
        }
