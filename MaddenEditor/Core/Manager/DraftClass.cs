    ...
    public class Combine
    {
        ...
        public void Init(Player player)
        {
            ...
            for (int c = 0; c < 2; c++)
            {
                ...
                double speed = 12.43 * player.Original_Ratings.SPEED / 100;         //  Fastest speed based on Usain Bolt
                double accel = 5.2 * player.Original_Ratings.ACCELERATION / 100;    //  Guesstimate
                double time = speed / accel;                                        //  99 spd and 99 acc would be about 4.17 40yds this should be extremely RARE
                ...
                if (result < 4.15)                                                  // can't be faster than 4.15
                    result = 4.15;
