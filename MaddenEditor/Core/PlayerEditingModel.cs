...
namespace MaddenEditor.Core
{
    ...
    public class PlayerEditingModel
    {
        ...
        private string currentCollegeFilter = null; //new
        /** The current college filter */
        ...
        public int filterarchetype = -1; //here
        public int filtercollege = -1;  //new
        public int filterarchetypes = -1;    //new
        public int filterdevtrait = -1; //new
        public int filterYearsPro = -1; //new
        public bool filterdraft = false;
        public bool filterprobowl = false;
        ...
        public PlayerEditingModel(EditorModel model)
        {
            ...
            else if (model.MadVersion == MaddenFileVersion.Ver2020)
            {
                ...
                helmetlist.Add(new GenericRecord("Schutt Air XP PRO VTD", 2));
                helmetlist.Add(new GenericRecord("VICIS ZERO1", 3));
                helmetlist.Add(new GenericRecord("Riddell VSR4 Softcup", 4));
                helmetlist.Add(new GenericRecord("Schutt Vengeance Pro", 5));
                helmetlist.Add(new GenericRecord("Riddell Revolution", 6));
                helmetlist.Add(new GenericRecord("Riddell Revolution Speed", 7));
                helmetlist.Add(new GenericRecord("Riddell Speed Flex", 8));
                ...
                helmetlist.Add(new GenericRecord("Vengeance Z10", 13));
                helmetlist.Add(new GenericRecord("Schutt F7", 14));
                helmetlist.Add(new GenericRecord("Xenith Shadow", 15));
                helmetlist.Add(new GenericRecord("Vicis Zero 2", 16));
                helmetlist.Add(new GenericRecord("Vicis Zero 2 Trench", 17));
                helmetlist.Add(new GenericRecord("Riddell Axiom", 18));
                helmetlist.Add(new GenericRecord("None", 19));
            }
            #endregion
            #endregion
            ...
            #region 20
            {
                ...
                facemasklist.Add(new GenericRecord("3 Bar Single", 3));
                facemasklist.Add(new GenericRecord("3 Bar QB", 4));
                facemasklist.Add(new GenericRecord("3 Bar RB Single", 5));
                facemasklist.Add(new GenericRecord("3 Bar RB", 6));
                facemasklist.Add(new GenericRecord("3 Bar RB Jagged", 7));
                facemasklist.Add(new GenericRecord("Bull RB", 8));
                facemasklist.Add(new GenericRecord("Robot", 9));
                facemasklist.Add(new GenericRecord("Robot RB", 10));
                facemasklist.Add(new GenericRecord("Full Cage Robot", 11));
                facemasklist.Add(new GenericRecord("Full Cage Hook", 12));
                ...
                facemasklist.Add(new GenericRecord("Revo Speed 2 Bar WR", 90));
                facemasklist.Add(new GenericRecord("Revo Speed Full Cage Hook", 91));
                facemasklist.Add(new GenericRecord("2 Bar WR", 92));
                facemasklist.Add(new GenericRecord("Vengeance Z10 Robot", 93));
                facemasklist.Add(new GenericRecord("Vengeance Z10 2 Bar", 94));
                facemasklist.Add(new GenericRecord("Vengeance Z10 3 Bar LB", 95));
                facemasklist.Add(new GenericRecord("Vengeance Z10 Cage", 96));
                ...
                facemasklist.Add(new GenericRecord("Schutt F7 Robot RB", 102));
                facemasklist.Add(new GenericRecord("Schutt F7 3 Bar RB", 103));
                facemasklist.Add(new GenericRecord("Schutt F7 Fullcage", 104));
                facemasklist.Add(new GenericRecord("Revo Speed Half Cage", 105));
                facemasklist.Add(new GenericRecord("Vengeance 3 Bar", 106));
                facemasklist.Add(new GenericRecord("Vengeance 2 Bar Single", 107));
                facemasklist.Add(new GenericRecord("Schutt F7 Fullcage Robot", 108));
                facemasklist.Add(new GenericRecord("Schutt F7 Robot RB 2", 109));
                facemasklist.Add(new GenericRecord("Schutt F7 Kicker", 110));
                facemasklist.Add(new GenericRecord("Speed Flex 808 ", 111));
                facemasklist.Add(new GenericRecord("Speed Flex 3 Bar ", 112));
                facemasklist.Add(new GenericRecord("Speed Flex Kicker ", 113));
                facemasklist.Add(new GenericRecord("Speed Flex Robot Cage ", 114));
                facemasklist.Add(new GenericRecord("Speed Flex 3 Bar RB Single ", 115));
                facemasklist.Add(new GenericRecord("Speed Flex Half Cage ", 116));
                facemasklist.Add(new GenericRecord("Speed Flex Fullcage Robot ", 117));
                facemasklist.Add(new GenericRecord("Speed Flex Fullcage Hook ", 118));
                facemasklist.Add(new GenericRecord("Speed Flex Cage Hook ", 119));
                facemasklist.Add(new GenericRecord("Speed Flex Bulldog ", 120));
                facemasklist.Add(new GenericRecord("Speed Flex RB Bull ", 121));
                facemasklist.Add(new GenericRecord("Speed Flex 3 Bar LB Grid ", 122));
                facemasklist.Add(new GenericRecord("Speed Flex 3 Bar Jagged", 123));
                facemasklist.Add(new GenericRecord("Speed Flex 3 Bar RB Jagged ", 124));
                facemasklist.Add(new GenericRecord("Xenith Kicker ", 125));
                facemasklist.Add(new GenericRecord("3 Bar QB Single", 126));
                facemasklist.Add(new GenericRecord("2 Bar QB Single", 127));
                facemasklist.Add(new GenericRecord("2 Bar QB Bull", 128));
                facemasklist.Add(new GenericRecord("Flat Half Cage", 129));
                facemasklist.Add(new GenericRecord("Half Cage 3", 130));
                facemasklist.Add(new GenericRecord("2 Bar Nose", 131));
                facemasklist.Add(new GenericRecord("3 Bar Nose", 132));
                facemasklist.Add(new GenericRecord("Vintage Kicker", 133));
                facemasklist.Add(new GenericRecord("Vintage 2 Bar Bull", 134));
                facemasklist.Add(new GenericRecord("Vintage Half Cage", 135));
                facemasklist.Add(new GenericRecord("Vintage 2 Bar QB Single", 136));
                facemasklist.Add(new GenericRecord("Vintage 2 Bar Nose", 137));
                facemasklist.Add(new GenericRecord("Vintage Half Cage 2", 138));
                facemasklist.Add(new GenericRecord("Vicis Kicker", 139));
                facemasklist.Add(new GenericRecord("Speedflex 2 Bar WR", 140));
                facemasklist.Add(new GenericRecord("Speedflex Jewel", 141));
                facemasklist.Add(new GenericRecord("Speedflex Robot 808", 142));
                facemasklist.Add(new GenericRecord("Revospeed Robot Cage", 143));
                facemasklist.Add(new GenericRecord("Speedflex Half Cage 2", 144));
                facemasklist.Add(new GenericRecord("Xenith Prowl", 145));
                facemasklist.Add(new GenericRecord("Speedflex Robot Z", 146));
                facemasklist.Add(new GenericRecord("Vicis ZERO2 2 Bar", 147));
                facemasklist.Add(new GenericRecord("Vicis ZERO2 Robot", 148));
                facemasklist.Add(new GenericRecord("Vicis ZERO2 Robot RB", 149));
                facemasklist.Add(new GenericRecord("Vicis ZERO2 Robot RB 2", 150));
                facemasklist.Add(new GenericRecord("Vicis ZERO2 3 Bar RB", 151));
                facemasklist.Add(new GenericRecord("Vicis ZERO2 3 Bar LB", 152));
                facemasklist.Add(new GenericRecord("Vicis ZERO2 Robot LB", 153));
                facemasklist.Add(new GenericRecord("Vicis ZERO2 Trench", 154));
                facemasklist.Add(new GenericRecord("Vicis ZERO2 Kicker", 155));
            }
            #endregion 20
            ...
            {
                shoelist.Add(new GenericRecord("Adidas Freak", 0));
                shoelist.Add(new GenericRecord("Adidas AdiZero Primeknit", 1));
                shoelist.Add(new GenericRecord("Nike Alpha Pro 2 3/4 TD", 2));
                shoelist.Add(new GenericRecord("Nike Vapor Untouchable", 3));
                shoelist.Add(new GenericRecord("Nike Vapor Carbon Elite TD", 4));
                shoelist.Add(new GenericRecord("Player Exclusive Low", 5));
                shoelist.Add(new GenericRecord("Nike Alpha Menace Elite", 6));
                shoelist.Add(new GenericRecord("Nike Vapor Untouchable 2", 7));
                shoelist.Add(new GenericRecord("Nike Vintage 70s80s", 8));
                shoelist.Add(new GenericRecord("Pintos", 9));
                shoelist.Add(new GenericRecord("Nike Lunar Beast", 10));
                shoelist.Add(new GenericRecord("Nike Zoom Code Elite", 11));
                shoelist.Add(new GenericRecord("Player Exclusive Hightop", 12));
                shoelist.Add(new GenericRecord("Player Exclusive Super", 13));
                ...
                shoelist.Add(new GenericRecord("Nike Field General", 20));
                shoelist.Add(new GenericRecord("Nike Vapor Untouchable Pro", 21));
                shoelist.Add(new GenericRecord("99 Club Force Savage Elite 2", 22));
                shoelist.Add(new GenericRecord("99 Club Jordan 5", 23));
                shoelist.Add(new GenericRecord("Nike Alpha Menace Pro 2", 24));
                shoelist.Add(new GenericRecord("Nike Force Savage Pro 2", 25));
                shoelist.Add(new GenericRecord("Adidas Freak Ultra", 26));
                shoelist.Add(new GenericRecord("Air Jordan Retro", 27));
                shoelist.Add(new GenericRecord("Taped Player Exclusive", 28));
                shoelist.Add(new GenericRecord("Nike Force Savage Elite 2", 29));
                shoelist.Add(new GenericRecord("Nike Vapor Edge", 30));
                shoelist.Add(new GenericRecord("Nike Alpha Menace Elite 2", 31));
                shoelist.Add(new GenericRecord("Nike Vapor Untouchable 3", 32));
                shoelist.Add(new GenericRecord("Jordan X Low", 33));
                shoelist.Add(new GenericRecord("Jordan X Mid", 34));
                shoelist.Add(new GenericRecord("Adidas Nasty", 35));
                shoelist.Add(new GenericRecord("99 Club Alpha Menace Pro 2", 39));
                shoelist.Add(new GenericRecord("Jordan Low 5", 40));
                shoelist.Add(new GenericRecord("Jordan Mid 5", 41));
                shoelist.Add(new GenericRecord("Nike Vapor Edge Speed FOTF PE", 42));
                shoelist.Add(new GenericRecord("Nike Alpha Menace Elite 3", 43));
                shoelist.Add(new GenericRecord("Nike Alpha Menace Pro 3", 44));
                shoelist.Add(new GenericRecord("Jordan Mid 7", 46));
                shoelist.Add(new GenericRecord("Air Jordan Retro Low", 47));
                shoelist.Add(new GenericRecord("Player Exclusive Primary", 47));
                shoelist.Add(new GenericRecord("Adidas Adizero", 48));
                shoelist.Add(new GenericRecord("Player Exclusive Secondary", 48));
                shoelist.Add(new GenericRecord("Nike Vapor Edge Dunk", 49));
                shoelist.Add(new GenericRecord("Exclusive S White", 49));
                shoelist.Add(new GenericRecord("Nike Equinox", 50));
            }
            ...
            else if (model.MadVersion == MaddenFileVersion.Ver2020)
            {
                ...
                glovelist.Add(new GenericRecord("Nike Vapor Jet White", 1));
                glovelist.Add(new GenericRecord("Nike Vapor Jet Black", 2));
                glovelist.Add(new GenericRecord("Nike Vapor Jet TeamColor", 3));
                glovelist.Add(new GenericRecord("Adidas Adizero 11 White", 4));
                glovelist.Add(new GenericRecord("Adidas Adizero 11 Black", 5));
                glovelist.Add(new GenericRecord("Adidas Adizero 11 TeamColor", 6));
                glovelist.Add(new GenericRecord("Nike SuperBad3 White", 7));
                glovelist.Add(new GenericRecord("Nike SuperBad3 Black", 8));
                glovelist.Add(new GenericRecord("Nike SuperBad3 TeamColor", 9));
                glovelist.Add(new GenericRecord("Nike VaporKnit White", 10));
                glovelist.Add(new GenericRecord("Nike VaporKnit Black", 11));
                glovelist.Add(new GenericRecord("Nike VaporKnit TeamColor", 12));
                glovelist.Add(new GenericRecord("Nike HyperBeast White", 13));
                glovelist.Add(new GenericRecord("Nike HyperBeast Black", 14));
                glovelist.Add(new GenericRecord("TapedHandFinger White", 15));
                glovelist.Add(new GenericRecord("TapedHandFinger Black", 16));
                glovelist.Add(new GenericRecord("TapedHandFinger TeamColor", 17));
                glovelist.Add(new GenericRecord("TapedHandNormal White", 18));
                glovelist.Add(new GenericRecord("TapedHandMax White", 19));
                glovelist.Add(new GenericRecord("TapedHandCombo White", 20));
                glovelist.Add(new GenericRecord("UnderArmourSpotlight TeamColor", 21));
                glovelist.Add(new GenericRecord("UnderArmourF6 TeamColor", 22));
                glovelist.Add(new GenericRecord("NikeVaporJet SecondaryColor", 23));
                glovelist.Add(new GenericRecord("Adizero11 SecondaryColor", 24));
                glovelist.Add(new GenericRecord("NikeSuperBad3 SecondaryColor", 25));
                glovelist.Add(new GenericRecord("NikeVaporKnit SecondaryColor", 26));
                glovelist.Add(new GenericRecord("UnderArmourSpotlight SecondaryColor", 27));
                glovelist.Add(new GenericRecord("UnderArmourF6 SecondaryColor", 28));
                glovelist.Add(new GenericRecord("NikeVaporJet4 Black", 29));
                glovelist.Add(new GenericRecord("NikeVaporJet4 White", 30));
                glovelist.Add(new GenericRecord("NikeVaporJet4 TeamColor", 31));
                glovelist.Add(new GenericRecord("NikeVaporJet4 SecondaryColor", 32));
                glovelist.Add(new GenericRecord("NikeVaporJet5 Black", 33));
                glovelist.Add(new GenericRecord("NikeVaporJet5 White", 34));
                glovelist.Add(new GenericRecord("NikeVaporJet5 TeamColor", 35));
                glovelist.Add(new GenericRecord("NikeVaporJet5 SecondaryColor", 36));
                glovelist.Add(new GenericRecord("NikeSuperbad5 Black", 37));
                glovelist.Add(new GenericRecord("NikeSuperbad5 White", 38));
                glovelist.Add(new GenericRecord("NikeSuperbad5 TeamColor", 39));
                glovelist.Add(new GenericRecord("NikeSuperbad5 SecondaryColor", 40));
                glovelist.Add(new GenericRecord("NikeVaporKnit2 Black", 41));
                glovelist.Add(new GenericRecord("NikeVaporKnit2 White", 42));
                glovelist.Add(new GenericRecord("NikeVaporKnit2 TeamColor", 43));
                glovelist.Add(new GenericRecord("NikeVaporKnit2 SecondaryColor", 44));
                glovelist.Add(new GenericRecord("GenericCutter Black", 45));
                glovelist.Add(new GenericRecord("GenericCutter White", 46));
                glovelist.Add(new GenericRecord("GenericCutter TeamColor", 47));
                glovelist.Add(new GenericRecord("GenericCutter SecondaryColor", 48));
                glovelist.Add(new GenericRecord("UnderArmourSpotlight White", 49));
                glovelist.Add(new GenericRecord("UnderArmourSpotlight Black", 50));
                glovelist.Add(new GenericRecord("UnderArmourF6 White", 51));
                glovelist.Add(new GenericRecord("UnderArmourF6 Black", 52));
                glovelist.Add(new GenericRecord("JordanVaporJet5 Black", 53));
                glovelist.Add(new GenericRecord("JordanVaporJet5 TeamColor", 54));
                glovelist.Add(new GenericRecord("JordanVaporJet5 SecondaryColor", 55));
                glovelist.Add(new GenericRecord("JordanVaporJet5 White", 56));
                glovelist.Add(new GenericRecord("Hand Amputee", 57));
                glovelist.Add(new GenericRecord("NikeVaporJet6 Black", 58));
                glovelist.Add(new GenericRecord("NikeVaporJet6 TeamColor", 59));
                glovelist.Add(new GenericRecord("NikeVaporJet6 SecondaryColor", 60));
                glovelist.Add(new GenericRecord("NikeVaporJet6 White", 61));
                glovelist.Add(new GenericRecord("NikeVaporKnit3 TeamColor", 62));
                glovelist.Add(new GenericRecord("NikeVaporKnit3 SecondaryColor", 63));
                glovelist.Add(new GenericRecord("NikeVaporKnit3 Black", 64));
                glovelist.Add(new GenericRecord("NikeVaporKnit3 White", 65));
                glovelist.Add(new GenericRecord("NikeVaporJet6 TeamColor", 68));
                glovelist.Add(new GenericRecord("NikeVaporJet6 SecondaryColor", 69));
                glovelist.Add(new GenericRecord("NikeVaporJet6 White", 70));
                glovelist.Add(new GenericRecord("NikeVaporJet6 Black", 71));
                glovelist.Add(new GenericRecord("AdidasFreak TeamColor", 72));
                glovelist.Add(new GenericRecord("AdidasFreak SecondaryColor", 73));
                glovelist.Add(new GenericRecord("AdidasFreak Black", 74));
                glovelist.Add(new GenericRecord("AdidasFreak White", 75));
                glovelist.Add(new GenericRecord("NikeVaporJet7 White", 76));
                glovelist.Add(new GenericRecord("NikeVaporJet7 Black", 77));
                glovelist.Add(new GenericRecord("NikeVaporJet7 TeamColor", 78));
                glovelist.Add(new GenericRecord("NikeVaporJet7 SecondaryColor", 79));
                glovelist.Add(new GenericRecord("NikeSuperbad6 White", 80));
                glovelist.Add(new GenericRecord("NikeSuperbad6 Black", 81));
                glovelist.Add(new GenericRecord("NikeSuperbad6 TeamColor", 82));
                glovelist.Add(new GenericRecord("NikeSuperbad6 SecondaryColor", 83));
                glovelist.Add(new GenericRecord("JordanSuperbad6 White", 84));
                glovelist.Add(new GenericRecord("JordanSuperbad6 Black", 85));
                glovelist.Add(new GenericRecord("JordanSuperbad6 TeamColor", 86));
                glovelist.Add(new GenericRecord("JordanSuperbad6 SecondaryColor", 87));
                glovelist.Add(new GenericRecord("JordanVaporJet7 White", 88));
                glovelist.Add(new GenericRecord("JordanVaporJet7 Black", 89));
                glovelist.Add(new GenericRecord("JordanVaporJet7 TeamColor", 90));
                glovelist.Add(new GenericRecord("JordanVaporJet7 SecondaryColor", 91));
                glovelist.Add(new GenericRecord("Hand Amputee", 92));
            }
            else
            {
            ...
            if (model.MadVersion >= MaddenFileVersion.Ver2019)
            {
                ...
                wristbandlist.Add(new GenericRecord("Double Wristbands White", 4));
                wristbandlist.Add(new GenericRecord("Double Wristbands Black", 5));
                wristbandlist.Add(new GenericRecord("Double Wristbands Team Color", 6));
                ...
                wristbandlist.Add(new GenericRecord("Taped Wrists Normal", 11));
                wristbandlist.Add(new GenericRecord("Taped Wrists Max", 12));
                ...
                wristbandlist.Add(new GenericRecord("Wristband Secondary Color", 18));
                wristbandlist.Add(new GenericRecord("Double Wristbands Secondary Color", 19));
                ...
                wristbandlist.Add(new GenericRecord("Taped Wrists Max Black ", 22));
                wristbandlist.Add(new GenericRecord("Taped Wrists Lite Primary", 23));
                wristbandlist.Add(new GenericRecord("Taped Wrists Normal Primary", 24));
                wristbandlist.Add(new GenericRecord("Taped Wrists Max Primary", 25));
                ...
                wristbandlist.Add(new GenericRecord("Taped Wrists Max Secondary", 28));
                wristbandlist.Add(new GenericRecord("*G_WristBand_Coach_TeamColor", 29)); //vanity
                wristbandlist.Add(new GenericRecord("*G_WristTaped_Max_TeamColor", 30)); //vanity
            }
            else
            {
            ...
            if (model.MadVersion >= MaddenFileVersion.Ver2019)
            {
                ...
                sleeveslist.Add(new GenericRecord("LongArmTape White", 20));
                sleeveslist.Add(new GenericRecord("HalfSleeveSecondary", 21));
                sleeveslist.Add(new GenericRecord("UndershirtSecondary", 22));

                if (model.MadVersion == MaddenFileVersion.Ver2020)
                {
                    sleeveslist.Add(new GenericRecord("Short Arm Tape Black", 31));
                    sleeveslist.Add(new GenericRecord("Short Arm Tape Primary", 32));
                    sleeveslist.Add(new GenericRecord("Short Arm Tape Secondary", 33));
                    sleeveslist.Add(new GenericRecord("Long Arm Tape Black", 34));
                    sleeveslist.Add(new GenericRecord("Long Arm Tape Primary", 35));
                    sleeveslist.Add(new GenericRecord("Long Arm Tape Secondary", 36));
                    sleeveslist.Add(new GenericRecord("*Baggy Sleeve White", 37));      //new 12-30-23
                    sleeveslist.Add(new GenericRecord("*Baggy Sleeve Black", 38));      //new 12-30-23
                    sleeveslist.Add(new GenericRecord("*Baggy Sleeve Team Color", 39));     //new 12-30-23
                    sleeveslist.Add(new GenericRecord("*Baggy Sleeve Secondary Color", 40));        //new 12-30-23
                }
            }
            else
            {
            ...
            if (model.MadVersion >= MaddenFileVersion.Ver2019)
            {
                ...
                else if (model.MadVersion == MaddenFileVersion.Ver2020)
                {
                    ...
                    anklelist.Add(new GenericRecord("Black Half Splat", 3));
                    anklelist.Add(new GenericRecord("Black Full Splat", 4));
                    anklelist.Add(new GenericRecord("Primary Half Splat", 5));
                    anklelist.Add(new GenericRecord("Primary Full Splat", 6));
                    anklelist.Add(new GenericRecord("Secondary Half Splat", 7));
                    anklelist.Add(new GenericRecord("Secondary Full Splat", 8));
                }
            }
            else
            {
            ...
            if (model.MadVersion < MaddenFileVersion.Ver2019)
            {
                ...
                visorlist.Add(new GenericRecord("Dark", 3));
            }
            else
            {
                visorlist.Add(new GenericRecord("None", 0));
                ...
                visorlist.Add(new GenericRecord("Oakley Clear", 4));
                visorlist.Add(new GenericRecord("Oakley Prizm", 5));
                visorlist.Add(new GenericRecord("Oakley Smoke", 6));
                visorlist.Add(new GenericRecord("Oakley Dark", 7));
            }
            #endregion
            ...
            if (model.MadVersion >= MaddenFileVersion.Ver2019)
            {
                archetypelist.Add(new GenericRecord("Field General QB", 0));
                archetypelist.Add(new GenericRecord("Strong Arm QB", 1));
                archetypelist.Add(new GenericRecord("Improviser QB", 2));
                archetypelist.Add(new GenericRecord("Scrambler QB", 3));
                archetypelist.Add(new GenericRecord("Power Back RB", 4));
                archetypelist.Add(new GenericRecord("Elusive Back RB", 5));
                archetypelist.Add(new GenericRecord("Receiving Back RB", 6));
                archetypelist.Add(new GenericRecord("Blocking FB", 7));
                archetypelist.Add(new GenericRecord("Utility FB", 8));
                archetypelist.Add(new GenericRecord("Deep Threat WR", 9));
                archetypelist.Add(new GenericRecord("Route Runner WR", 10));
                archetypelist.Add(new GenericRecord("Physical WR", 11));
                archetypelist.Add(new GenericRecord("Slot WR", 12));
                ...
                archetypelist.Add(new GenericRecord("Run Stopper DT", 28));
                archetypelist.Add(new GenericRecord("Speed Rusher DT", 29));
                archetypelist.Add(new GenericRecord("Power Rusher DT", 30));
                archetypelist.Add(new GenericRecord("Speed Rusher OLB", 31));
                archetypelist.Add(new GenericRecord("Power Rusher OLB", 32));
                archetypelist.Add(new GenericRecord("Pass Coverage OLB", 33));
                archetypelist.Add(new GenericRecord("Run Stopper OLB", 34));
            ...
            SidelineHeadGear.Add(new GenericRecord("Helmet On", 0));
            SidelineHeadGear.Add(new GenericRecord("Helmet Partially On", 1));
            SidelineHeadGear.Add(new GenericRecord("Hat Forward On", 2));
            SidelineHeadGear.Add(new GenericRecord("Hat Backward On", 3));
            SidelineHeadGear.Add(new GenericRecord("Visor On", 4));
            SidelineHeadGear.Add(new GenericRecord("Hat Specific On", 5));
            SidelineHeadGear.Add(new GenericRecord("Helmet Off", 6));
        ...
        public void SetCollegeFilter(string college) //new
        {
            currentCollegeFilter = college;
        }

        public void RemoveCollegeFilter()   //new
        {
            currentCollegeFilter = null;
        }
        ...
        public List<string> GetPlayerList()
        {
            ...
            foreach (TableRecordModel rec in model.TableModels[EditorModel.PLAYER_TABLE].GetRecords())
            {
                ...
                if (filterdraft && play.YearsPro != 0)
                    continue;
                if (filterprobowl && !play.ProBowl)
                    continue;

                // Check for team filter
                if (filterteam != -1 && play.TeamId != filterteam)
                    continue;

                // Check for position filter
                if (filterposition != -1 && play.PositionId != filterposition)
                    continue;

                // Check for college filter
                if (filtercollege != -1 && play.CollegeId != filtercollege)
                    continue;

                // Check for Dev Trait filter
                if (filterdevtrait != -1 && play.DevTrait != filterdevtrait)
                    continue;

                // Check for Archetypes Trait filter (Not sure)
                if (filterarchetypes != -1 && play.PlayerType!= filterarchetypes)
                    continue;

                // Check for Years Pro filter
                if (filterYearsPro != -1 && play.YearsPro != filterYearsPro)
                    continue;
        ...
        public int GetActivePlayerCount()
        {
            ...
            foreach (TableRecordModel rec in model.TableModels[EditorModel.PLAYER_TABLE].GetRecords())
            {
                ...
                // Check for Archetypes Trait filter
                if (filterarchetypes != -1 && play.PlayerType != filterarchetypes)
                    continue;
