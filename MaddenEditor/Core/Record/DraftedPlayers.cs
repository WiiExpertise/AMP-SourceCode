...
namespace MaddenEditor.Core.Record
{
    public class DraftedPlayers : TableRecordModel
    {
        ...
        // 2004 has player ability ratings as well, not assigning those
        ...
        public const string DRAFT_PICK_ROUND = "DRPR";          // 15
        ...
        public const string PLAYER_WRA = "PWRA";                // some type of rating 
        ...
        {
            get { return GetIntField(PLAYER_WRA); }
            set { SetField(PLAYER_WRA, value); }
        }
