...
namespace MaddenEditor.Core.Record
{
    ...
    public class PlayerRecord : TableRecordModel
    {
        ...
        public const string CHEST_DEFN = "N/A";                //2019
        public const string CHEST_SIZE = "N/A";                //2019
        public const string CALF_DEFN = "BSCA";                 //2019
        public const string CALF_SIZE = "BSCT";                 //2019
        ...
        public const string SHOULDER_HEIGHT = "BSPA";           //2019 (Chest)
        public const string PAD_SIZE = "BSPT";                  //2019 (Chest)
        ...
        public const string PLAYER_JERSEY_TUCKED = "PJST";      //2024
        ...
        public const string RUN_STYLE = "PRSE";                 // 2019
        ...
        public int ProBowlFilter
        {
            get
            {
                return GetIntField(PRO_BOWL);
            }
            set
            {
        ...
        public int RunStyle
        {
            get { return GetIntField(RUN_STYLE); }
            set { SetField(RUN_STYLE, value); }
        }
        public int PlayerTowel
        {
            get { return GetIntField(PLAYER_TOWEL); }
            set { SetField(PLAYER_TOWEL, value); }
        }
        ...
        public int HandWarmer
        {
            get { return (GetIntField(HAND_WARMER)); }
            set { SetField(HAND_WARMER,value); }
        }
        ...
        public int JerseyTucked //2024
        {
            get { return GetIntField(PLAYER_JERSEY_TUCKED); }
            set { SetField(PLAYER_JERSEY_TUCKED,value); }
        }
        ...
        public float ArmDefn    //Body edit
        {
            get { return GetFloatField(ARM_DEFN); }
            set { SetField(ARM_DEFN, value); }
        }
        public float ArmSize    //Body Edit
        {
        ...
        public int CalculateOverallRating(int positionId, bool withHeightAndWeight)
        {
            ...
            if (withHeightAndWeight)
            {
                ...
                tempOverall = (positionId);
            }

            switch (positionId)
            {
                case (int)MaddenPositions.QB:
                    tempOverall = (0.50 * Awareness + 0.10 * ThrowDeep + 0.10 * ThrowMedium + 0.10 * ThrowShort + 0.10 * ThrowPower + 0.10 * ThrowPressure);
                    tempOverall = (int)Math.Round((decimal)Convert.ToInt32(tempOverall));
                    break;
                case (int)MaddenPositions.HB:
                    tempOverall = (0.50 * Awareness + 0.10 * Carrying + 0.10 * RB_Vision + 0.10 * BreakTackle19 + 0.10 * ShortRoute + 0.10 * Catching);
                    tempOverall = (int)Math.Round((decimal)Convert.ToInt32(tempOverall));
                    break;
                case (int)MaddenPositions.FB:
                    tempOverall = (0.50 * Awareness + 0.10 * LeadBlock + 0.10 * Catching + 0.10 * Carrying + 0.10 * PassBlocking + 0.10 * RunBlocking);
                    tempOverall = (int)Math.Round((decimal)Convert.ToInt32(tempOverall));
                    break;
                case (int)MaddenPositions.WR:
                    tempOverall = (0.50 * Awareness + 0.10 * ShortRoute + 0.10 * MediumRoute + 0.10 * DeepRoute + 0.10 * Catching + 0.10 * CatchTraffic);
                    tempOverall = (int)Math.Round((decimal)Convert.ToInt32(tempOverall));
                    break;
                case (int)MaddenPositions.TE:
                    tempOverall = (0.50 * Awareness + 0.10 * ShortRoute + 0.10 * Catching + 0.10 * PassBlocking + 0.10 * RunBlocking + 0.10 * CatchTraffic);
                    tempOverall = (int)Math.Round((decimal)Convert.ToInt32(tempOverall));
                    break;
                case (int)MaddenPositions.LT:
                case (int)MaddenPositions.RT:
                    tempOverall = (0.50 * Awareness + 0.10 * PassBlockStrength + 0.10 * PassBlockStrength + 0.10 * RunBlockStrength + 0.10 * RunBlockStrength + 0.10 * Strength);
                    tempOverall = (int)Math.Round((decimal)Convert.ToInt32(tempOverall));
                    break;
                ...
                case (int)MaddenPositions.RE:
                    tempOverall = (0.50 * Awareness + 0.10 * PowerMoves + 0.10 * FinesseMoves + 0.10 * Pursuit + 0.10 * Tackle + 0.10 * PlayRecognition);
                    tempOverall = (int)Math.Round((decimal)Convert.ToInt32(tempOverall));
                    break;
                case (int)MaddenPositions.DT:
                    tempOverall = (0.50 * Awareness + 0.10 * PowerMoves + 0.10 * FinesseMoves + 0.10 * BlockShedding + 0.10 * Tackle + 0.10 * Strength);
                    tempOverall = (int)Math.Round((decimal)Convert.ToInt32(tempOverall));
                    break;
                ...
                case (int)MaddenPositions.MLB:
                    tempOverall = (0.50 * Awareness + 0.10 * PlayRecognition + 0.10 * Pursuit + 0.10 * Tackle + 0.10 * ZoneCoverage + 0.10 * BlockShedding);
                    tempOverall = (int)Math.Round((decimal)Convert.ToInt32(tempOverall));
                    break;
                case (int)MaddenPositions.CB:
                    tempOverall = (0.50 * Awareness + 0.10 * ZoneCoverage + 0.10 * ManCoverage + 0.10 * Pursuit + 0.10 * PlayRecognition + 0.10 * 0.10 * PressCover);
                    tempOverall = (int)Math.Round((decimal)Convert.ToInt32(tempOverall));
                    break;
                case (int)MaddenPositions.FS:
                    tempOverall = (0.50 * Awareness + 0.10 * ZoneCoverage + 0.10 * ManCoverage + 0.10 * Pursuit + 0.10 * PlayRecognition + 0.10 * 0.10 * Tackle);
                    tempOverall = (int)Math.Round((decimal)Convert.ToInt32(tempOverall));
                    break;
                ...
                case (int)MaddenPositions.P:
                    tempOverall = (0.50 * Awareness + 0.25 * KickPower + 0.25 * KickAccuracy);
                    tempOverall = (int)Math.Round((decimal)Convert.ToInt32(tempOverall));
                    break;
