...
namespace MaddenEditor.Core.Record
{
    public class TeamRecord : TableRecordModel
    {
        ...
        public const string ADVISORS_COMMENT_1 = "OAC1";
        public const string ADVISORS_COMMENT_2 = "OAC2";
        public const string ADVISORS_COMMENT_3 = "OAC3";
        public const string ADVISORS_COMMENT_4 = "OAC4";
        public const string ADVISORS_COMMENT_5 = "OAC5";
        ...
        public const string TEAM_DB_NAME = "TDAN";              //2019
        ...
        public const string TEAM_NICK_NAME = "TMNC";            // 2005+
        public const string TMPS = "TMPS";
        public const string TEAM_RELOCATED = "TMRE";
        ...
        public const string TEAM_VISIBLE = "TVIS";
        ...
        public string Name
        {
            get { return GetStringField(TEAM_NAME); }
        ...
        public int TeamVisible      //New 12-23-23
        {
            get { return GetIntField(TEAM_VISIBLE); }
            set { SetField(TEAM_VISIBLE, value); }
        }
        ...
        public int SalaryCapPenalty0
        {
            get { return GetIntField(SALARY_CAP_PENALTY_THIS_YEAR); }
            set { SetField(SALARY_CAP_PENALTY_THIS_YEAR, value); }
        }
        public int SalaryCapPenalty1
        {
            get { return GetIntField(SALARY_CAP_PENALTY_NEXT_YEAR); }
            set { SetField(SALARY_CAP_PENALTY_NEXT_YEAR, value); }
        }
        ...
        {
            get { return GetStringField(TEAM_SHORT_NAME); }
            set { SetField(TEAM_SHORT_NAME, value); }
        }
        public string CustomArt
        {
            get { return GetStringField(CUSTOM_ART_FILE); }
            set { SetField(CUSTOM_ART_FILE, value); }
        }
        ...
        public int PreviousSeasonWins
        {
            get { return GetIntField(PREVIOUS_SEASON_WINS); }
            set { SetField(PREVIOUS_SEASON_WINS, value); }
        }
        public int PreviousSeasonLosses
        {
            get { return GetIntField(PREVIOUS_SEASON_LOSSES); }
            set { SetField(PREVIOUS_SEASON_LOSSES, value); }
        }
        public int PreviousSeasonTies
        {
            get { return GetIntField(PREVIOUS_SEASON_TIES); }
            set { SetField(PREVIOUS_SEASON_TIES, value); }
        }

        public int SeasonConfStanding
        {
        ...
        public bool TeamRelocated
        {
            get
            {
                return (GetIntField(TEAM_RELOCATED) == 1);
            }
            set
            {
                SetField(TEAM_RELOCATED, Convert.ToInt32(value));
            }
        }

        public string TeamDB
        {
            get { return GetStringField(TEAM_DB_NAME); }
            set { SetField(TEAM_DB_NAME, value); }
        }
