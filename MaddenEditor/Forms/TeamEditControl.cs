    ...
    public partial class TeamEditControl : UserControl, IEditorForm
    {
        ...
        private void LoadTeamInfo(TeamRecord record)
        {
            ...
            try
            {
                ...
                TeamSalarytextBox1.Text = "NA";
                TeamSalarytextBox1.Text = "";
                ...
                TeamVisible.Value = record.TeamVisible;
        ...
        private void TeamVisibile_ValueChanged(object sender, EventArgs e)
        {
            if (!isInitialising)
                model.TeamModel.CurrentTeamRecord.TeamVisible = (int)TeamVisible.Value;
        }
