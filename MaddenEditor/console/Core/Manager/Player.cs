...
namespace MaddenEditor.Core.Manager
{
    ...
    public class PlayerAppearance
    {
        ...
        public bool EYE_PAINT = false;                  //"PEYE";
        ...
        public void Read(BinaryReader binreader)
        {
            ...
            EYE_PAINT = binreader.ReadBoolean();
